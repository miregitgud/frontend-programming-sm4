...
const users = [
  {
  "name": "Ayyash", "age": 20, "major": "Technology Informatics"
  },
  {
  "name": "Kayla", "age": 19, "major": "Physiology"
  },
  {
  "name": "Ale", "age": 20, "major": "Economics"
  },
  {
  "name": "Iffa", "age": 19, "major": "Psychology"
  },
  {
  "name": "Thoriq", "age": 19, "major": "System Informatics"
  }
]
...
const all = () => {
  for (const user of users){
    console.log(`Menampilkan detail dari semua data: \n${user.name} \n${user.age} \n${user.major} \n`);
};
}
